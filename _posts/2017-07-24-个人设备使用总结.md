...
+ [Google Chrome下载地址](https://api.shuax.com/tools/getchrome) [^1]
+ [Visual Studio](https://www.visualstudio.com/zh-hans/)
+ [Visual Studio Code](https://code.visualstudio.com/)
+ [Sublimetext](https://www.sublimetext.com/3)

[^1]: [Green Chrome](https://shuax.com/portfolio/greenchrome/) ;

### Chrome插件
+ [Tampermonkey](https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo?utm_source=chrome-app-launcher-info-dialog) [^2]
